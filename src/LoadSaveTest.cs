...
namespace Potassium
{
    public partial class LoadSaveTestForm : Form
    {
        ...
        public LoadSaveTestForm()
        {
            ...
            cmbGame.DataSource = new BindingSource(Enum.GetValues(typeof(GcGame)).Cast<GcGame>()
        ...
        private void btnStartTest_Click(object sender, EventArgs e)
        {
            ...
            backgroundWorkerRunTests.RunWorkerAsync(new RunTestsWorkerParams
            {
                ...
                game = (GcGame)cmbGame.SelectedValue,
