...
namespace Potassium
{
    public partial class OldWindow : Form
    {
        ...
        public OldWindow()
        {
            ...
            // Populate ComboBox values from GcGame enum dynamically.
            tsCmbGame.ComboBox.ValueMember = "Key";
            tsCmbGame.ComboBox.DisplayMember = "Value";
            tsCmbGame.ComboBox.DataSource = new BindingSource(Enum.GetValues(typeof(GcGame)).Cast<GcGame>()
        ...
        private GcGame GetSelectedGame()
        {
            return (GcGame)tsCmbGame.ComboBox.SelectedValue;
        }
        ...
        private static void DrawUnitCube()
        {
        ...
        #region Stage Layout File Handling
        private void tsBtnLoadStageLayout_Click(object sender, EventArgs e)
        {
